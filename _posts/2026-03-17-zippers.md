...
![The original and updated trees share the unchanged y node]({{ "/assets/posts/understanding-zippers/zippers-access-example.svg" | relative_url }})
...
![A zipper focused on the root with an empty breadcrumb stack]({{ "/assets/posts/understanding-zippers/zipper-at-root.svg" | relative_url }})
...
![The zipper after moving down to tree_a]({{ "/assets/posts/understanding-zippers/zipper-focused-on-a.svg" | relative_url }})
...
![The zipper after moving down to tree_b]({{ "/assets/posts/understanding-zippers/zipper-focused-on-b.svg" | relative_url }})
...
![The zipper after moving down to the x value]({{ "/assets/posts/understanding-zippers/zipper-focused-on-x.svg" | relative_url }})
...
![The zipper after rebuilding tree_b with the modified x value]({{ "/assets/posts/understanding-zippers/zipper-after-go-up.svg" | relative_url }})
